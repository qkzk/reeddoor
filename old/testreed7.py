...
def dooropened():
	...
	if t%20==0: #temps d'alerte x5 secondes
		longopen(t)
		socketconnect(str(time.time())+" up") #envoie un msg de up au socketserver avec le temps en s
...
def doorclosed():
	...
	if f%20==0: #fermee depuis 5s
		socketconnect(str(time.time())+" up") #envoie un msg de up au socketserver
